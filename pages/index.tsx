...
export default function Home() {
    return (
        <div>
            ...
            <main>
                <div style={{  height: "100vh", backgroundColor: "#2c2c2c", width: "100vw", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}}>
                    <h1 style={{ padding: "5rem", fontFamily: "Poppins", color: "#eb6157",  fontSize:"5rem" }}>Website under construction! Please check in later :D</h1>
